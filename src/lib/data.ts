...
export const inflatableCatalogue: Inflatable[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1599302928543-35c635a604f7?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1552511484-9a0c64a852a4?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1621262342122-458151216a9a?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1543883391-2b6947f632ac?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1597169428691-380186c34825?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1612994793833-39a0b3815338?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1551431829-43a1d31d9a04?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1518933928879-c51121a5a075?q=80&w=600&h=400&fit=crop',
    ageSuitability: 'age_5_plus',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1563291074-2bf8677ac0e5?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1565995487493-94b2a8f870f7?q=80&w=600&h=400&fit=crop',
    ageSuitability: 'all_ages',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1524903236960-9b489953894b?q=80&w=600&h=400&fit=crop',
    ageSuitability: 'all_ages',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1574503794350-f813a84c8e7e?q=80&w=600&h=400&fit=crop',
    ageSuitability: 'all_ages',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1611095966432-87cdf9913333?q=80&w=600&h=400&fit=crop',
    ageSuitability: 'all_ages',
...
export const blogPosts: BlogPost[] = [
  {
    ...
    date: '2024-05-15',
    categoryKey: 'safety',
    image: 'https://images.unsplash.com/photo-1568602471322-7826d3a36c94?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600&h=400&fit=crop',
  ...
  },
  {
    ...
    date: '2024-06-01',
    categoryKey: 'events',
    image: 'https://images.unsplash.com/photo-1511795409834-ef04bbd51622?q=80&w=600&h=400&fit=crop',
    hint: 'event calendar',
  ...
  },
  {
    ...
    date: '2024-04-28',
    categoryKey: 'tips',
    image: 'https://images.unsplash.com/photo-1504805572947-34fad45aed93?q=80&w=600&h=400&fit=crop',
...
export const galleryImages: GalleryImage[] = [
  { src: 'https://images.unsplash.com/photo-1519638848496-c95574c10a45?q=80&w=600&h=600&fit=crop', alt: 'Enfants jouant dans un château gonflable', hint: 'children playing' },
  { src: 'https://images.unsplash.com/photo-1549298453-2c1854cc3334?q=80&w=600&h=800&fit=crop', alt: 'Toboggan géant lors d\'une fête d\'école', hint: 'giant slide' },
  { src: 'https://images.unsplash.com/photo-1533234421-44051a4456a6?q=80&w=800&h=600&fit=crop', alt: 'Parcours d\'obstacles coloré', hint: 'obstacle course' },
  { src: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=600&h=600&fit=crop', alt: 'Fête d\'anniversaire avec thème pirate', hint: 'birthday party' },
  { src: 'https://images.unsplash.com/photo-1506522019183-5a0a38e5e3a8?q=80&w=800&h=600&fit=crop', alt: 'Structure aquatique en été', hint: 'water park' },
  { src: 'https://images.unsplash.com/photo-1554463441-3e42c554a9e5?q=80&w=600&h=800&fit=crop', alt: 'Sourires d\'enfants sur un jeu gonflable', hint: 'happy children' },
  { src: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=600&h=600&fit=crop', alt: 'Événement d\'entreprise avec des jeux pour adultes', hint: 'corporate event' },
  { src: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=600&h=600&fit=crop', alt: 'Installation de nos équipes', hint: 'team setup' },
];
